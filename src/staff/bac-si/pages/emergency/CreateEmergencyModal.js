...
import { doctorEmergencyAPI, departmentAPI, employeeAPI } from '../../../../services/staff/doctorAPI';
...
const CreateEmergencyModal = ({ encounterId, onClose, onSuccess }) => {
    ...
    const fetchNurses = async () => {
        try {
            const response = await employeeAPI.getNurses();
            if (response && response.data) {
    ...
    const fetchDoctors = async () => {
        try {
            const response = await employeeAPI.getDoctors();
            if (response && response.data) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await doctorEmergencyAPI.createEmergencyFromEncounter(submitData);
