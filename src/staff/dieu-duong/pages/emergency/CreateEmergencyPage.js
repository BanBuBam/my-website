...
import { nurseEmergencyAPI, nursePatientSearchAPI, nurseDepartmentAPI, nurseEmployeeAPI } from '../../../../services/staff/nurseAPI';
...
const CreateEmergencyPage = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                // Load nurses
                const nurseResponse = await nurseEmployeeAPI.getNurses(0, 100);
    ...
    const loadDoctorsByDepartment = async (departmentId) => {
        try {
            const response = await nurseEmployeeAPI.getDoctorsByDepartment(departmentId);
    ...
    const handleSearchPatients = async () => {
        ...
        try {
            ...
            const response = await nursePatientSearchAPI.searchPatientsByName(patientSearchQuery, 0, 10);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await nurseEmergencyAPI.createEmergency(submitData);
